        ...
        <nav class="navbar navbar-default">
            <div class="container-fluid">
                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="active"><a href="findForum.php">Find Forum</a></li>
...
<div class="container">
    <div id="floating-panel">
        ...
        <select id="end">
            ...
            $order=[];
            foreach ($distanceResult as $sortedList)  {
                $order[]=$sortedList['id'];
            }
            foreach ($order as $id) {
                echo "<option value=".$menu_items[$id]['latlng'].">{$menu_items[$id]['name']}</option>";
            }
            ?>
        </select>
    </div>
